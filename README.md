...
## Quick Install
    ...
    curl https://raw.githubusercontent.com/fvermeulen/vimfiles/master/bootstrap.sh -o - | sh
...
Note: You will already have a `~/.vim` folder, either delete or move it.
    ...
    mv ~/.vim ~/.vim.old
    git clone https://github.com/fvermeulen/vimfiles ~/.vim
    cd ~/.vim
    rake install

or run:

    curl https://raw.github.com/fvermeulen/vimfiles/master/bootstrap.sh -o - | sh
